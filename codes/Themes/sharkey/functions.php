...
function twentyten_widgets_init() {
	...
	register_sidebar( array(
		...
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '<strong class="widget-title"><span>',
	...
	// Area 3
	register_sidebar( array(
		'name' => __( 'Logo', 'twentyten' ),
		'id' => 'logo',
		'description' => __( 'Logo', 'twentyten' ),
		'before_widget' => '',
		'after_widget' => '',
	...
	// Area 4
	register_sidebar( array(
		'name' => __( 'Tagline', 'twentyten' ),
		'id' => 'tagline',
		'description' => __( 'Tagline', 'twentyten' ),
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '<strong class="widget-title">',
		'after_title' => '</strong>',
	...
	// Area 5
	register_sidebar( array(
		'name' => __( 'Call Us', 'twentyten' ),
		'id' => 'call',
		'description' => __( 'Call Us', 'twentyten' ),
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '<strong class="widget-title">',
		'after_title' => '</strong>',
	...
	// Area 6
	register_sidebar( array(
		'name' => __( 'Top Contact Information', 'twentyten' ),
		'id' => 'top-info',
		'description' => __( 'Top Contact Information', 'twentyten' ),
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '<strong class="widget-title">',
		'after_title' => '</strong>',
	...
	// Area 7
	register_sidebar( array(
		'name' => __( 'Search Box', 'twentyten' ),
		'id' => 'search',
		'description' => __( 'Search Box', 'twentyten' ),
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '<strong class="widget-title">',
		'after_title' => '</strong>',
	...
	// Area 8
	register_sidebar( array(
		'name' => __( 'Equipment Manufacturers', 'twentyten' ),
		'id' => 'em',
		'description' => __( 'Equipment Manufacturers', 'twentyten' ),
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '<strong class="widget-title">',
		'after_title' => '</strong>',
	...
	// Area 9
	register_sidebar( array(
		'name' => __( 'Footer Social Icons', 'twentyten' ),
		'id' => 'social',
		'description' => __( 'Footer Social Icons', 'twentyten' ),
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '<strong class="widget-title">',
		'after_title' => '</strong>',
	...
	register_sidebar( array(
		...
		'id' => 'footer-text',
		'description' => __( 'Footer Text', 'twentyten' ),
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '<strong class="widget-title">',
		'after_title' => '</strong>',
	...
	// Area 12
	register_sidebar( array(
		'name' => __( 'Banner Navigation', 'twentyten' ),
		'id' => 'banner-navigation',
		'description' => __( 'Banner Navigation', 'twentyten' ),
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '<strong class="widget-title">',
		'after_title' => '</strong>',
