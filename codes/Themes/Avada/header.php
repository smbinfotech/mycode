...
<head>
	...
	#sidebar .widget_links li a:hover:before,.side-nav .arrow:hover:after{
		xcolor:<?php echo $data['primary_color']; ?>;
	}
	#nav ul .current_page_item a, #nav ul .current-menu-item a, #nav ul > .current-menu-parent a,
	...
	#nav ul a:hover{
		xborder-color:<?php echo $data['primary_color']; ?>;
	}
	.side-nav li.current_page_item a{
	...
	#nav ul a{
		xborder-color:<?php echo $data['header_bg_color']; ?> !important;	
	}
	<?php endif; ?>
	...
	.footer-area{
		xbackground-color:<?php echo $data['footer_bg_color']; ?> !important;
	}
	<?php endif; ?>
	...
	#footer{
		xbackground-color:<?php echo $data['copyright_bg_color']; ?> !important;
	}
	<?php endif; ?>

	<?php if($data['copyright_border_color']): ?>
	#footer{
		xborder-color:<?php echo $data['copyright_border_color']; ?> !important;
	}
	<?php endif; ?>
	...
	table th{
		xfont-family:<?php echo $headings_font; ?>;
	}
	<?php endif; ?>
	...
	body,#sidebar .slide-excerpt h2, .footer-area .slide-excerpt h2{
		xfont-size:<?php echo $data['body_font_size']; ?>px;
		<?php
		$line_height = round((1.5 * $data['body_font_size']));
		?>
		xline-height:<?php echo $line_height; ?>px;
	}
	.project-content .project-info h4{
	...
	body,#sidebar .slide-excerpt h2, .footer-area .slide-excerpt h2{
		xline-height:<?php echo $data['body_font_lh']; ?>px !important;
	}
	.project-content .project-info h4{
	...
	#sidebar .widget h3{ xfont-size:<?php echo $data['sidew_font_size']; ?>px !important;}
	<?php endif; ?>

	<?php if($data['footw_font_size']): ?>
	.footer-area h3{xfont-size:<?php echo $data['footw_font_size']; ?>px !important;}
	<?php endif; ?>

	<?php if($data['copyright_font_size']): ?>
	.copyright{xfont-size:<?php echo $data['copyright_font_size']; ?>px !important;}
	<?php endif; ?>

	<?php if($data['responsive']): ?>
	#header .avada-row, #main .avada-row, .footer-area .avada-row, #footer .avada-row{ max-width:1120px; position: relative; }
	<?php endif; ?>
	...
	.post-content h2,.title h2,#main .post-content .title h2,.page-title h1,#main .post h2 a{
		xfont-size:<?php echo $data['h2_font_size']; ?>px !important;
		<?php
	...
	.post-content h2,.title h2{
		xcolor:<?php echo $data['h2_color']; ?> !important;
	}
	<?php endif; ?>

	<?php if($data['h3_color']): ?>
	.post-content h3,#sidebar .widget h3,.project-content h3,.title h3,#header .tagline,.person-author-wrapper span{
		xcolor:<?php echo $data['h3_color']; ?> !important;
	}
	<?php endif; ?>
	...
	body a,.project-content .project-info .project-info-box a,#sidebar .widget li a, #sidebar .widget .recentcomments, #sidebar .widget_categories li, #main .post h2 a{xcolor:<?php echo $data['link_color']; ?>;}
	<?php endif; ?>
	...
	.footer-area h3{xcolor:<?php echo $data['footer_headings_color']; ?> !important;}
	<?php endif; ?>

	<?php if($data['footer_text_color']): ?>
	.footer-area,.footer-area #jtwt,.copyright{xcolor:<?php echo $data['footer_text_color']; ?> !important;}
	<?php endif; ?>

	<?php if($data['footer_link_color']): ?>
	.footer-area a,.copyright a{xcolor:<?php echo $data['footer_link_color']; ?> !important;}
	<?php endif; ?>
	...
	#nav ul ul{xbackground-color:<?php echo $data['menu_sub_bg_color']; ?>;}
	<?php endif; ?>

	<?php if($data['menu_sub_color']): ?>
	#wrapper #nav ul li ul li a,.side-nav li li a,.side-nav li.current_page_item li a{xcolor:<?php echo $data['menu_sub_color']; ?> !important;}
	<?php endif; ?>
	...
	#wrapper #nav ul li ul li a{xborder-bottom:1px solid <?php echo $data['menu_sub_sep_color']; ?> !important;}
	<?php endif; ?>

	<?php if($data['menu_bg_hover_color']): ?>
	#wrapper #nav ul li ul li a:hover, #wrapper #nav ul li ul li.current-menu-item a{xbackground-color:<?php echo $data['menu_bg_hover_color']; ?> !important;}
	<?php endif; ?>
	...
	#nav ul ul{
		xwidth:<?php echo $data['dropdown_menu_width']; ?> !important;
	}
	<?php endif; ?>
...
<script type="text/javascript">
jQuery(document).ready(function(){ 
jQuery("#searches").click(function() {
jQuery("form.search").slideToggle(500);
});
//jQuery("#nav .menu").append("<li class='client-access menu-item menu-item-type-post_type menu-item-object-page menu-item-client' id='menu-item-client'><a target='_blank' href='/client-access'>Client Access</a></li>");
var i = 0;
jQuery("#front-cta .widget_text").attr('class', function() {
i++;
return 'widget_text widget cta'+i;
});
var j = 0;
jQuery("#sidebar .widget_text").attr('class', function() {
j++;
return 'widget_text widget widgets'+j;
});
jQuery(".ans-cta-wrap p").each(function() {
jQuery('.ans-cta-wrap p:empty').remove();
});
var k = 0;
jQuery(".footer-widget-col .socialmedia-buttons a").attr('class', function() {
k++;
return 'social social'+k;
});

var social1 = jQuery("a.social1 img").attr('src');
var social2 = jQuery("a.social2 img").attr('src');
var social3 = jQuery("a.social3 img").attr('src');
var social4 = jQuery("a.social4 img").attr('src');
var path = jQuery('.logo a').attr('href');
var social1_hover = "/wp-content/themes/Avada/images/facebook_hover.png";
var social2_hover = "/wp-content/themes/Avada/images/linkedin_hover.png";
var social3_hover = "/wp-content/themes/Avada/images/rss_hover.png";
var social4_hover = "/wp-content/themes/Avada/images/googleplus_hover.png";

jQuery("a.social1").hover(function() {
jQuery("a.social1 img").attr('src',path+social1_hover);
}, function() {
jQuery("a.social1 img").attr('src',social1);
});
  
jQuery("a.social2").hover(function() {
jQuery("a.social2 img").attr('src',path+social2_hover);
}, function() {
jQuery("a.social2 img").attr('src',social2);
});

jQuery("a.social3").hover(function() {
jQuery("a.social3 img").attr('src',path+social3_hover);
}, function() {
jQuery("a.social3 img").attr('src',social3);
});
  
jQuery("a.social4").hover(function() {
jQuery("a.social4 img").attr('src',path+social4_hover);
}, function() {
jQuery("a.social4 img").attr('src',social4);
});
jQuery("<div class='clrs'></div>" ).insertAfter("#wpmem_login .button_div .buttons");
var i = 0;
...
<body <?php body_class($avada_color_scheme); ?>>
    ...
    <div class="guarantee-box">
    	<?php dynamic_sidebar('guarantee-widget'); ?>
    <div class="clrs"></div>
    </div>
    <div class="clrs"></div>
    </div>
	...
	<div id="main" class="<?php echo $main_class; ?>" style="<?php echo $main_css; ?>">
