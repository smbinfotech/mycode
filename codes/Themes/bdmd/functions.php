...
function twentythirteen_setup() {
	...
	register_nav_menu( 'top', __( 'Top Menu', 'bdmd' ) );
...
function twentythirteen_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Footer Widget Area', 'bdmd' ),
		'id'            => 'footer',
		'description'   => __( 'Appears on Footer.', 'bdmd' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget'  => '</div>',
	) );
	
	register_sidebar( array(
		'name'          => __( 'Team Page Widget Area', 'bdmd' ),
		'id'            => 'team',
		'description'   => __( 'Appears on Team pages.', 'bdmd' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget'  => '</div>',
	) );
	
		register_sidebar( array(
		'name'          => __( 'Blog Widget Area', 'bdmd' ),
		'id'            => 'sidebar-blog',
		'description'   => __( 'Appears on Blog pages.', 'bdmd' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget'  => '</div>',
	) );
	
		register_sidebar( array(
		'name'          => __( 'People Page Sidebar', 'bdmd' ),
		'id'            => 'sidebar-people',
		'description'   => __( 'Appears on People page.', 'bdmd' ),
		'before_widget' => '<div id="%1$s" class="people-widget %2$s">',
		'after_widget'  => '</div>',
...
function twentythirteen_post_nav() {
	...
	<nav class="navigation post-navigation" role="navigation">
		...
		<div class="nav-links">
			...
			<?php previous_post_link( '%link', _x( 'Previous Post<br>%title', 'Previous post link', 'twentythirteen' ) ); ?>
			<?php next_post_link( '%link', _x( 'Next Post<br>%title', 'Next post link', 'twentythirteen' ) ); ?>
...
function add_custom_taxonomies() {
  ...
  register_taxonomy('people', 'projects', array(
  ...
  // Add new "Market Type" taxonomy to Projects
  register_taxonomy('market-type', 'projects', array(
    // Hierarchical taxonomy (like categories)
    'hierarchical' => true,
    // This array of options controls the labels displayed in the WordPress Admin UI
	'public' =>true,
    'labels' => array(
      'name' => _x( 'Market Type', 'taxonomy general name' ),
      ...
      'new_item_name' => __( 'New People Market Type' ),
      'menu_name' => __( 'Market Type' ),
    ),
    // Control the slugs used for this taxonomy
    'rewrite' => array(
      'slug' => 'market-type', // This controls the base slug that will display before each term
      'with_front' => false, // Don't display the category base before "/locations/"
      'hierarchical' => true // This will allow URL's like "/locations/boston/cambridge/"
    ),
  ));  
...
if ( function_exists( 'add_image_size' ) ) { 
    add_image_size( 'thumbs', 250, 200, true ); //(cropped)
}
